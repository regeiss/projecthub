...
-- PostgreSQL 16
-- 
-- IMPORTANTE: Este script APENAS cria extensões, schemas e funções auxiliares.
-- Todas as tabelas são criadas pelo Django ORM através de migrations.
-- =============================================================================
...
-- =============================================================================
-- FUNÇÕES AUXILIARES (criadas por migrations do Django)
-- =============================================================================

-- Esta função é criada e mantida pelo Django através das migrations.
-- Aqui apenas registramos sua definição para referência:
...
-- END INIT SCRIPT
-- =============================================================================
-- Todas as tabelas serão criadas por:
--   python manage.py migrate
-- 
-- Se estiver rodando em produção com Docker, certifique-se de que:
--   1. Apenas o container 'api' executa migrations
--   2. Os workers esperam o API estar saudável antes de iniciar
-- ============================================================================
