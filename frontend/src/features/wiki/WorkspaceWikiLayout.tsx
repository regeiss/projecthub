...
export function WorkspaceWikiLayout() {
  const { space, isLoading } = useWorkspaceWikiSpace()
      ...
      <div className="flex h-full flex-col items-center justify-center gap-4 text-center">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">
            Crie a wiki do workspace para documentação geral
          </p>
        </div>
        {createSpace.isError && (
        ...
        <Button
          ...
          onClick={() => createSpace.mutate({ projectId: null, name: 'Wiki' })}
          aria-label="Criar wiki do workspace"
        >
