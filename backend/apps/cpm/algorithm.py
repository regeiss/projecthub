        ...
        tasks.append(
            {
                ...
                "assignee_name": issue.get("assignee__name"),
                "assignee_avatar": issue.get("assignee__avatar_url"),
                "state_name": issue.get("state__name"),
                "state_color": issue.get("state__color"),
            }
        )
